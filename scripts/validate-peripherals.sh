...
source)
    ...
    require_fragment 'echo netdev > "$LED/trigger"' "$blue" 'Blue LED cannot use explicit WLAN trigger'
    require_fragment 'echo none > "$LED/trigger"' "$blue" 'Blue LED cannot return to manual mode'
